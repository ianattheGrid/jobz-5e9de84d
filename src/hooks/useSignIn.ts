    ...
    try {
      ...
      if (userRole.role === 'vr') {
        ...
        if (profileError || !vrProfile) {
          ...
          try {
            // Using insert with partial data - the vr_number will be generated by the database trigger
            const { error: createError } = await supabase
              ...
              .insert({
                ...
                location: '', // Empty string instead of null for required field
                bank_account_verified: false
              } as any); // Using type assertion to bypass strict TypeScript checking
