      ...
      try {
        ...
        if (!existingProfile) {
          try {
            ...
            // Insert profile with required fields - using type assertion to handle vr_number 
            // which gets generated by a database trigger
            const { data: newProfile, error: createError } = await supabase
              ...
              .insert([{
                ...
                is_active: true
              }] as any) // Type assertion to bypass the vr_number requirement, which is DB generated
              .select()
              .single();
