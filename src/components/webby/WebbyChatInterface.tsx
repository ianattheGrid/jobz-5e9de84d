...
interface WebbyChatInterfaceProps {
  userType: 'candidate' | 'employer';
  onComplete?: () => void;
}

export const WebbyChatInterface = ({ userType, onComplete }: WebbyChatInterfaceProps) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Check if conversation seems complete (basic heuristic)
  ...
  return (
    <div className="flex flex-col h-[600px] bg-card rounded-lg border border-border">
      <div className="flex items-center gap-2 p-4 border-b border-border bg-gradient-to-r from-primary/10 to-primary/5">
        ...
        <h3 className="font-semibold">Chat with Webby</h3>
      </div>
