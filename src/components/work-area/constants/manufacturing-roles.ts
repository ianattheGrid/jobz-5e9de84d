...
export const qualityAssuranceRoles = [
  "Compliance Officer (Manufacturing)",
...
export const specializedManufacturingRoles = [
  "Aerospace Manufacturing Engineer",
  "Automotive Manufacturing Specialist",
...
export const manufacturingSpecializations = [
