...
import { Building2, UserRound, UserPlus } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-white">
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          ...
          <div className="flex flex-col items-center p-8 rounded-lg bg-white shadow-lg max-w-sm w-full">
            <UserPlus className="w-16 h-16 text-red-800 mb-4" />
            <h2 className="text-xl font-semibold text-red-800 mb-2">Virtual Recruiter</h2>
            <p className="text-gray-600 text-center mb-4">Recommend candidates and earn commission</p>
            <div className="flex flex-col gap-2 w-full">
              <Button asChild variant="outline" className="w-full">
                <Link to="/vr/signup">Sign Up</Link>
              </Button>
              <Button asChild variant="outline" className="w-full">
                <Link to="/vr/signin">Sign In</Link>
              </Button>
            </div>
          </div>
        </div>
