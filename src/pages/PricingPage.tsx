      ...
      <div className="relative pt-20">
        ...
        <div className="bg-card/60 backdrop-blur border border-primary/30 rounded-lg p-6 mb-12 text-center shadow-[0_0_40px_-10px_hsl(var(--primary)/0.4)]">
          ...
          <p className="text-white/70">
            We're currently beta testing in the Bristol area. During this period, <strong className="text-white">all services are completely free!</strong>{" "}
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="relative overflow-hidden border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 group">
            ...
            <CardHeader className="relative text-center pt-8 pb-4 text-white">
            ...
            <CardContent className="relative space-y-3 px-6 pb-8 text-white">
              {employerFeatures.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 bg-white/10 rounded-lg p-3 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="flex-shrink-0 w-6 h-6 bg-white rounded-full flex items-center justify-center">
                    <Check className="h-4 w-4 text-slate-800 font-bold" />
                  </div>
              ...
              <div className="pt-6">
                <Link to="/employer/signup">
                  <Button className="w-full bg-white hover:bg-gray-100 text-slate-800 py-4 text-lg font-bold shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-white/30">
                    🚀 Get Started Now
                  </Button>
                </Link>
              </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-left">
            <div className="bg-card/60 backdrop-blur rounded-lg p-6 shadow-sm border border-border">
              <h3 className="font-semibold text-white mb-2">Is there really no charge during beta testing?</h3>
              <p className="text-white/70">
            ...
            <div className="bg-card/60 backdrop-blur rounded-lg p-6 shadow-sm border border-border">
              <h3 className="font-semibold text-white mb-2">When will regular pricing start?</h3>
              <p className="text-white/70">
