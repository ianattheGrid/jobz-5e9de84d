          ...
          <div className="space-y-3 text-center mb-6">
            <div className="flex items-center justify-center gap-3">
              <div className="relative">
                <Building2 className="h-8 w-8 text-primary drop-shadow-[0_0_20px_rgba(236,72,153,0.8)]" />
                <Sparkles className="h-4 w-4 text-primary absolute -top-1 -right-1 animate-pulse" />
              </div>
            </div>
            <h1 className="text-2xl font-bold text-white drop-shadow-[0_0_10px_rgba(236,72,153,0.5)]">
              {resetMode ? "Reset Your Password" : "Ready to Find Your Next Hire?"}
            </h1>
            <p className="text-sm text-white/70">
              {resetMode 
                ? "Enter your email and we'll send you a reset link" 
                : "Welcome back. Your next great hire is waiting."}
            </p>
          </div>
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-center">
              ...
              <div className="text-sm text-white/70">
                ...
                <Link to="/employer/signup" className="text-primary hover:text-primary/80 transition-colors drop-shadow-[0_0_10px_rgba(236,72,153,0.5)]">
                  Sign Up
                </Link>
              </div>
            </div>
