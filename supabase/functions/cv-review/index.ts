              ...
              parameters: {
                ...
                properties: {
                  ...
                  profileDraft: {
                    type: 'object',
                    description:
                      'Draft Jobz profile taken ONLY from facts stated in the CV. Leave a field out if the CV does not say.',
                    properties: {
                      fullName: { type: 'string' },
                      jobTitle: { type: 'string', description: 'Their current or most recent job title' },
                      desiredJobTitle: { type: 'string', description: 'The role they are aiming for next' },
                      yearsExperience: { type: 'number' },
                      skills: { type: 'array', items: { type: 'string' }, description: 'Up to 12 skills named in the CV' },
                      location: { type: 'string', description: 'Town or city stated in the CV' },
                      currentEmployer: { type: 'string' },
                      summary: { type: 'string', description: 'Two-sentence personal statement in their own voice' },
                    },
                  },
                },
                required: ['score', 'headline', 'strengths', 'issues', 'rewrittenBullets', 'profileDraft'],
