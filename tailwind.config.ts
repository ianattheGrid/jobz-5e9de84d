  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "typewriter": {
          "0%": { width: "0", borderRight: "2px solid currentColor" },
          "99%": { borderRight: "2px solid currentColor" },
          "100%": { width: "250ch", borderRight: "2px solid transparent" },
        },
        "typewriter-2": {
          "0%": { width: "0", opacity: "0", borderRight: "2px solid currentColor" },
          "0.1%": { opacity: "1", borderRight: "2px solid currentColor" },
          "99%": { borderRight: "2px solid currentColor" },
          "100%": { width: "250ch", opacity: "1", borderRight: "2px solid transparent" },
        },
        "typewriter-3": {
          "0%": { width: "0", opacity: "0", borderRight: "2px solid currentColor" },
          "0.1%": { opacity: "1", borderRight: "2px solid currentColor" },
        ...
        "typewriter-4": {
          "0%": { width: "0", opacity: "0", borderRight: "2px solid currentColor" },
          "0.1%": { opacity: "1", borderRight: "2px solid currentColor" },
          "100%": { width: "250ch", opacity: "1", borderRight: "2px solid currentColor" },
        },
        "blink": {
